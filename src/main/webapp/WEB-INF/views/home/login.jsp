...
<body
	...
	<div style="margin: 20px auto">
		<div style="margin: 100px auto; margin-bottom: 40px" align="center">
			<h1 style="font-size: 60px">欢迎登录阳光校园二手交易平台</h1>
		</div>
	</div>
	<div class="container" style="position: relative; margin: 80px auto;">
		<div class="col-md-6 login-back"
			...
			<!--把表单数据传输到指定action的路径页面去 ，相当于login？preURL=${preURL}。。。name-value传过去 访问后端会处理-->
			...
			<a style="float:left" href="/wzh-secondshop/admin/adminLogin">管理员登录</a> 
			<a style="float: right;color: red"  href="/wzh-secondshop/changepwd">忘记密码</a>
			<div align="center">
					<a style="text-align:center;color: green" href="/wzh-secondshop/">返回首页</a>
			</div>	
		</div>
	</div>
