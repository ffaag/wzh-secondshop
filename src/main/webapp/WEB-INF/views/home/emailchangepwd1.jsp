	...
	<div class="container" style="margin-top: 180px;">
		<div class="row">
			<div style="margin: 20px auto; color: #ffffff">
				<h1 align="center" ; style="color: #292b33">设置密码</h1>
			</div>

			<div class="col-xs-5 r"
				style="position: absolute; left: 50%; transform: translateX(-50%); padding: 30px; background-color: #ffffff">
				<form action="/wzh-secondshop/changepwd" method="post">
				<div class="form-group">
					 <label for="cemail">重新设置密码</label>
					 <input class="form-control" id="newPass1" name="newPass1" type="password"  />
				</div>
				<div class="form-group" align="center">
					 <label for="ccode" style="float:left" >确认密码</label>
					 <input class="form-control" id="newPass2" name="newPass2" type="password"/>
				</div>
				
				
				<div align="center">	<output id="passError" style="color: red"></output></div>
				
				<div class="form-group" align="center">
				    <button style="float:left;margin-left: 10px; width: 30%; margin: 20px" type="button"
					class="btn btn-primary" onclick="submitPass()">完成修改</button>
				<button style="float:right;margin-left: 10px; width: 30%; margin: 20px" type="button"
					class="btn btn-primary" onclick="location.href='changepwd'">上一步</button>
				</div>
